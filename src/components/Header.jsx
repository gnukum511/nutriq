    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          >
            {theme === "light"
              ? <Moon size={18} color="var(--cream)" strokeWidth={1.5} />
              : <Sun size={18} color="var(--cream)" strokeWidth={1.5} />
            }
          </HeaderButton>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              <Bell size={18} color="var(--cream)" strokeWidth={1.5} />
              {unreadCount > 0 && (
                <span
                  style={{
                    position: "absolute",
          ...
          >
            <LayoutGrid size={18} color="var(--cream)" strokeWidth={1.5} />
          </HeaderButton>
              ...
              {profileOpen && (
                <Dropdown width={200}>
                  ...
                  <DropdownItem onClick={() => { setProfileOpen(false); navigate("/") }}>
                    <Home size={14} color="var(--cream-dim)" strokeWidth={1.5} />
                    Home
                  </DropdownItem>
                  <DropdownItem onClick={() => { setProfileOpen(false); navigate("/tracker") }}>
                    <LayoutGrid size={14} color="var(--cream-dim)" strokeWidth={1.5} />
                    Tracker
                  </DropdownItem>
                  <DropdownItem onClick={() => { setProfileOpen(false); navigate("/settings") }}>
                    <Settings size={14} color="var(--cream-dim)" strokeWidth={1.5} />
                    Settings
                  </DropdownItem>
                  <DropdownItem onClick={() => { setProfileOpen(false); onSignOut?.() }}>
                    <LogOut size={14} color="var(--cream-dim)" strokeWidth={1.5} />
                    Sign Out
                  </DropdownItem>
                </Dropdown>
              )}
